...
export default function ProfileStats(props) {
  return (
    <div className="stats">
      <div className="box">
        <div className="item" title="Количество ваших изображений">
          <svg width="12px" height="12px" viewBox="2 3 20 18" fill="none">
            <path
              ...
              stroke={props.menuOpen ? "#808080" : "#adadad"}
              strokeWidth="2"
              strokeLinecap="round"
        ...
        <div className="item" style={{ color: props.menuOpen ? "#808080" : "#adadad" }}>
          {props.userData.imagesCount}
        </div>
      </div>
      <div className="box">
        <div className="item" title="Количество ваших открытых и закрытых коллекций">
          <svg fill={props.menuOpen ? "#808080" : "#adadad"} width="12px" viewBox="0 0 490 490">
        ...
        <div className="item" style={{ color: props.menuOpen ? "#808080" : "#adadad" }}>
          {props.userData.publicCollectionsCount}
        </div>
        <div className="item red-color">{props.userData.privateCollectionsCount} </div>
      </div>
    </div>
  );
}
