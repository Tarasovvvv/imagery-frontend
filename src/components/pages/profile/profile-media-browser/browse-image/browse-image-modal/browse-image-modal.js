        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <div style={{ marginRight: "25px" }}>
            <button
              ...
              onClick={async () => {
                const href = URL.createObjectURL(await (await fetch(props.data.image.link === null ? props.data.image.imageFile : props.data.image.link)).blob());
          ...
          <div style={{ marginLeft: "25px", display: "flex" }}>
            <Link to={`/@${props.user.userName}`}>
              {props.user.photoLink === null ? (
                ...
                <img src={props.user.photoLink} className="browse-image-modal-author-button" alt="Фото автора" />
              )}
            </Link>
            <Link to={`/@${props.user.userName}`} className="browse-image-modal-author-title">
              {props.user.userName}
            </Link>
          </div>
        </div>
